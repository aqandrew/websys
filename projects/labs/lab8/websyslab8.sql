...
--
-- Host: localhost
-- Generation Time: Nov 09, 2016 at 01:42 AM
...
--
ALTER TABLE `grades`
  ADD CONSTRAINT `grade_crn` FOREIGN KEY (`crn`) REFERENCES `courses` (`crn`),
  ADD CONSTRAINT `grade_rin` FOREIGN KEY (`rin`) REFERENCES `students` (`rin`);
