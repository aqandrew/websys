...
$loginStatement = $dbconn->prepare('SELECT username, uid FROM users WHERE username=:username AND ptpassword=:pass');
$loginStatement->execute(array(':username' => $_POST['username'], ':pass' => $_POST['pass']));
